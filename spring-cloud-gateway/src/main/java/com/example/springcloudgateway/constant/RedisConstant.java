...
public class RedisConstant {
    ...
    public static final String TAOBAO_SPECIAL = "taobao_special";
    ...
    public static final String MALL_LIST_DO = "mall_list_do_";

    public static final String MALL_RUN = "mall_run_";

    public static final String MALL_WAIT = "mall_wait_";
}
